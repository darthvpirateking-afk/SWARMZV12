...
class TaskExecutor:
    ...
    def register_task(self, name: str, task_func: Callable, metadata: Optional[Dict] = None):
    ...
    def list_tasks(self) -> Dict[str, Dict]:
        ...
        return {
            name: task["metadata"]
            for name, task in self.registered_tasks.items()
        }
...
class SwarmzCore:
    ...
    def _register_builtin_tasks(self):
        ...
        self.executor.register_task("echo", echo, {
            "description": "Echo a message back",
            "params": {"message": "string"}
        })
        
        self.executor.register_task("system_info", system_info, {
            "description": "Get system information"
        })
        
        self.executor.register_task("execute_python", execute_python, {
