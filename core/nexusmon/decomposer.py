...
class NexusmonDecomposer:
    ...
    def decompose(
        self, mission_id: str, intent: str, spec: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
        ...
        if any(
            ...
            for word in ["bio", "crispr", "protein", "dna", "sequence"]
        ):
        ...
        # Domain: Space Mission
            ...
            word in intent_lower
            for word in ["space", "orbital", "satellite", "telemetry", "burn"]
        ):
    ...
    def _decompose_space(
        self, intent: str, spec: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
