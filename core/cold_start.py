...
def _ensure_json_files() -> None:
    _safe_write_json(DATA_DIR / "state.json", {
        "mode": "COMPANION",
        "updated_at": _now(),
        "version": 1,
    })
    _safe_write_json(DATA_DIR / "personality_vector.json", {
        "risk_tolerance": 0.5,
        "speed_preference": 0.5,
        "exploration_bias": 0.5,
        "retry_patience": 0.5,
    })
    _safe_write_json(DATA_DIR / "companion_state.json", {
        "last_active_mission": None,
        "preferred_strategies": {},
        "recent_failures": [],
        "confidence_level": 0.5,
    })
    _safe_write_json(DATA_DIR / "companion_memory.json", {
    ...
    _safe_write_json(DATA_DIR / "companion_master.json", {
    ...
    _safe_write_json(DATA_DIR / "future_state.json", {
    ...
    _safe_write_json(DATA_DIR / "current_state.json", {
        "throughput": 0.0,
        "failure_rate": 0.0,
        "latency": 0.0,
        "resource_usage": 0.0,
    ...
    _safe_write_json(DATA_DIR / "state_of_life.json", {
        "time_allocation": {},
        "active_projects": 0,
        "financial_flow": {},
        "commitment_load": 0.0,
    ...
    _safe_write_json(DATA_DIR / "phase_patterns.json", {
    ...
    _safe_write_json(DATA_DIR / "uncertainty_profile.json", {
        "exploration_bias": 0.5,
        "confidence_level": 0.5,
...
def _ensure_text_files() -> None:
    ...
    _safe_touch_text(DATA_DIR / "decision_quality_report.txt", "No decision quality report yet.\n")
