...
WHITELISTED_ROOT_SCRIPTS = {
    ...
    "RUN.ps1",
    "RUN.sh",
    "SWARMZ_DAEMON_UP.cmd",
    "SWARMZ_DAEMON_UP.ps1",
    "SWARMZ_DOCTOR.cmd",
    "SWARMZ_DOCTOR.ps1",
    "SWARMZ_HOLOGRAM_SERVICE.ps1",
    "SWARMZ_MANUAL.cmd",
    "SWARMZ_MANUAL.ps1",
    "SWARMZ_ONE_BUTTON_DEPLOY.ps1",
    ...
    "SWARMZ_UP.cmd",
    "SWARMZ_UP.ps1",
    "SWARMZ_V5_LIVE_SETUP.ps1",
    "SWARMZ_V5_WSL_LIBVIRT_BOOTSTRAP.ps1",
    "SWARMZ_WSL_HOST_RECOVERY.ps1",
    "termux_hologram_run.sh",
    "termux_hologram_setup.sh",
    "termux_run.sh",
    "termux_setup.sh",
    "companion_cli.py",
    "companion_examples.py",
    "companion.py",
    "evaluation.py",
    "event_hooks.py",
    "examples.py",
    ...
    "nexusmon_operator_rank.py",
    "nexusmon_organism.py",
    "nexusmon_performance.py",
    "nexusmon_plugins.py",
    "nexusmon_signal_modules.py",
    "nexusmon_cognition.py",
    "nexusmon_mission_engine.py",
    "nexusmon_artifact_vault.py",
    "nexusmon_mentality.py",
    "nexusmon_sensorium.py",
    "nexusmon_forge.py",
    "nexusmon_nexus_vault.py",
    "nexusmon_linguistics.py",
    "sovereign_activation.py",
    "regan_message.py",
    "infuse_language_culture.py",
...
class VirusBuster:
    ...
    def scan_root(self) -> List[Path]:
        ...
        for file in root.iterdir():
            ...
            if (
                name in WHITELISTED_ROOT_SCRIPTS
                or name.startswith("nexusmon_")
    ...
    def neutralize(self, file_path: Path):
        ...
        dst = (
            QUARANTINE_DIR
            / f"{file_path.name}_{int(datetime.now().timestamp())}.quarantined"
        )
        ...
        try:
            ...
            telemetry.log_action(
                "WARNING",
                "BusterDefense",
                f"X-BUSTER: ROGUE {file_path.name} NEUTRALIZED",
            )
    ...
    def defend_system(self):
        ...
        if rogues:
            logger.info(
                f"SCAN COMPLETE: {len(rogues)} virally-active entities detected."
            )
            for rogue in rogues:
