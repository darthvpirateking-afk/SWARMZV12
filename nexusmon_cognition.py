...
def fuse_cognition(app) -> None:
    ...
    print("NEXUSMON Cognition Layer: 13 systems online.")
    print("  /v1/cognition/status — full readout")
    print("  /v1/cognition/predictions — Brier-scored forecasts")
    print("  /v1/cognition/belief-graph — dependency cascade")
    print("  /v1/cognition/argument/compile — argument validation")
    print("  /v1/cognition/argument/counter — steelman generator")
    print("  /v1/cognition/autopsy — decision classification")
    print("  /v1/cognition/counterfactual — alternative outcomes")
    print("  /v1/cognition/errors — error taxonomy")
    print("  /v1/cognition/abstraction — abstraction ladder")
    print("  /v1/cognition/prerequisites — concept dependencies")
    print("  /v1/cognition/causality — causal DAG builder")
    print("  /v1/cognition/sources — source reliability")
    print("  /v1/cognition/attention — focus tracking")
    print("  /v1/cognition/memory — distortion logging")
