# Termux Scripts for NEXUSMON

## Scripts

1. **start-nexusmon.sh**: Activates the virtual environment and starts the Uvicorn server.
...
3. Grant execute permissions: `chmod +x start-nexusmon.sh termux-boot.sh`.
