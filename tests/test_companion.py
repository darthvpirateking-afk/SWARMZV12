...
class TestWorkerSwarm(unittest.TestCase):
    ...
    def test_workflow_execution(self):
        ...
        task_context = TaskContext(task_id="test_task", intent="test intent")
...
class TestCommitEngine(unittest.TestCase):
    ...
    def test_action_ready_default(self):
        ...
        task_context = TaskContext(
            task_id="test", intent="safe task", parameters={"key": "value"}
        )
    ...
    def test_blocked_on_missing_params(self):
        ...
        task_context = TaskContext(task_id="test", intent="needs params", parameters={})
...
class TestIntelligenceLayer(unittest.TestCase):
    ...
    def test_predict_outcome_no_history(self):
        ...
        task_context = TaskContext(task_id="test", intent="new task")
    ...
    def test_predict_with_history(self):
        ...
        task_context = TaskContext(task_id="new", intent="test_task")
    ...
    def test_evolve_weights(self):
        ...
        self.assertNotEqual(self.intelligence.scoring_weights, initial_weights)
...
class TestEvolutionMechanism(unittest.TestCase):
    ...
    def test_apply_patchpack_requires_approval(self):
        ...
        patchpack = {"type": "routing_adjustment", "changes": {}}
...
class TestCompanionMode(unittest.TestCase):
    ...
    def test_conversation_history(self):
        ...
        self.assertEqual(
            len(self.companion_mode.conversation_history), 4
        )  # 2 user + 2 assistant
...
class TestOperatorMode(unittest.TestCase):
    ...
    def test_worker_results_recorded(self):
        ...
        self.assertGreater(
            len(self.operator_mode.intelligence.execution_logs), initial_logs
        )
...
class TestModeManager(unittest.TestCase):
    ...
    def test_process_input_routes_correctly(self):
        ...
        self.assertTrue(
            "[ACTION_READY]" in response
            or "[NEEDS_CONFIRM]" in response
    ...
    def test_memory_persistence(self):
        ...
        updates = {"preferences": {"theme": "dark"}, "caps": {"max_workers": 3}}
...
class TestTaskContext(unittest.TestCase):
    ...
    def test_task_context_creation(self):
        ...
        context = TaskContext(
            task_id="test_123", intent="test intent", parameters={"key": "value"}
        )
    ...
    def test_task_context_with_workers(self):
        ...
        context = TaskContext(task_id="test", intent="test")

        result = WorkerResult(
            result={"data": "test"}, risks=["risk1"], next_action="continue"
        )
