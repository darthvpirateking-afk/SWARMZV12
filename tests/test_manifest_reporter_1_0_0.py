"""Auto-generated manifest validation test for reporter@1.0.0.json."""
...
def test_manifest_reporter_1_0_0() -> None:
    repo_root = Path(__file__).resolve().parent.parent
    schema = json.loads((repo_root / "schemas" / "agent-manifest.v1.json").read_text(encoding="utf-8-sig"))
    manifest = json.loads((repo_root / "config" / "manifests" / "reporter@1.0.0.json").read_text(encoding="utf-8-sig"))
