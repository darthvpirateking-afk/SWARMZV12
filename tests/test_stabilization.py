...
def test_evaluate_blocks_on_cooldown():
    ...
    result = stabilization.evaluate({"action_type": "test_action"}, {})
...
def test_evaluate_blocks_on_oscillation():
    ...
    result = stabilization.evaluate({"action_type": "test"}, {"test_metric": 100.0})
...
def test_evaluate_passes_when_stable():
    ...
    result = stabilization.evaluate({"action_type": "test"}, {"stable_metric": 50.0})
