"""Auto-generated manifest validation test for reality_gate.manifest.json."""
...
def test_manifest_reality_gate_manifest() -> None:
    repo_root = Path(__file__).resolve().parent.parent
    schema = json.loads((repo_root / "schemas" / "agent-manifest.v1.json").read_text(encoding="utf-8-sig"))
    manifest = json.loads((repo_root / "config" / "manifests" / "reality_gate.manifest.json").read_text(encoding="utf-8-sig"))
