...
exports.PerformanceIndex = void 0;
class PerformanceIndex {
    constructor() {
        this.metrics = [];
        this.rollingWindow = 1000; // Keep last 1000 metrics
    }
    /**
     * Record a performance metric
     */
    record(metric_type, value, context) {
        this.metrics.push({
            timestamp: Date.now(),
            metric_type,
            value,
...
exports.PerformanceIndex = PerformanceIndex;
//# sourceMappingURL=performance_index.js.map