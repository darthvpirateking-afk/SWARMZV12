...
export function promoteBuildMilestone(target_stage: number): Promise<BuildMilestonesPromoteResponse> {
  return apiPost<BuildMilestonesPromoteResponse>("/v1/build/milestones/promote", { target_stage });
}
