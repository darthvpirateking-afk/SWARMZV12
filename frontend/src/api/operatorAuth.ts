...
export function verifyOperatorKey(operator_key: string): Promise<OperatorAuthVerifyResponse> {
  return apiPost<OperatorAuthVerifyResponse>("/v1/operator/auth/verify", { operator_key });
}
